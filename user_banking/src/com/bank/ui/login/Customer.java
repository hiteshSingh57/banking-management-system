...
public class Customer extends JPanel {
        ...
        public  Customer(CardLayout cardLayout,JPanel cardPanel) {
            ...
            gbc.weightx = 1;
            gbc.fill = GridBagConstraints.HORIZONTAL;
            JButton customerLogin = new JButton("Login");
            ...
            customerLogin.addActionListener(_ -> cardLayout.show(cardPanel, "CUSTOMER LOGIN"));
            ...
            JButton bankEmployee = new JButton("Sign up");
            ...
            bankEmployee.addActionListener(_ -> cardLayout.show(cardPanel,"SIGN_UP"));
